...
fun main() {
    ...
    // --- โจทย์: หาผลรวมราคาสินค้า Electronics ที่ราคามากกว่า 500 บาท ---

    // วิธีที่ 1: การใช้ Chaining กับ List โดยตรง
    ...
    // วิธีที่ 2: ใช้ .asSequence() (ขั้นสูง)
